...
//  http://localhost:8080/_002_RESTfulRESTEasy/rest/selam
@Path(value = "/selam")
public class Merkez {
...
//  http://localhost:8080/_002_RESTfulRESTEasy/rest/selam/sorgu3
	@GET 
	@Path("/sorgu3")
	@Produces("text/html")
...
//  http://localhost:8080/_002_RESTfulRESTEasy/rest/selam/sorgu4/{benimParametrem}
	@GET 
...
//  http://localhost:8080/_002_RESTfulRESTEasy/rest/selam/sorgu5/{benimParametrem}
	@GET 
	@Path("/sorgu5")
